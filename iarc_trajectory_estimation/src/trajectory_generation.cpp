...
{
    TrajectoryGenerationPolynomial::TrajectoryGenerationPolynomial(const ros::NodeHandle &nh,
                                                                   const ros::NodeHandle &nh_private) : nh_(nh),
                                                                                                        nh_private_(nh_private)
    {
        mav_odom_sub_ = nh_.subscribe("ground_truth/odometry", 10,
                                      &TrajectoryGenerationPolynomial::mavOdometryCallback, this);
